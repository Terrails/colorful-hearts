...
public class NeoMixinPlugin implements IMixinConfigPlugin {
    ...
    private static final Pattern MOD_ID_PATTERN = Pattern.compile("^terrails\\.colorfulhearts\\.extensions\\.neoforge\\.mixin\\.([a-z0-9_-]+)\\.([a-zA-Z]+)$");
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        ...
        if (matcher.matches()) {
            ...
            if (FMLLoader.getCurrent().getLoadingModList().getModFileById(modid) != null) {
                ...
                LogManager.getLogger("Colorful Hearts Extensions").info("Skipped applying mixin {} as mod {} is not present.", className, modid);
                return false;
            }
        }
        return true;
